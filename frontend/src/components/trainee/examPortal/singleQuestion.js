...
class SingleQuestion extends React.Component {
  constructor(props) {
    ...
    if (
      ...
      this.state = {
        AnswerSelected: true,
        options: this.props.trainee.questions[
          this.props.trainee.activeQuestionIndex
        ].options,
        answers: this.props.trainee.answers[
          this.props.trainee.activeQuestionIndex
        ].chosenOption,
        ticked: 0,
      };
  ...
  mark = () => {
    ...
    c.isMarked = !this.props.trainee.answers[
      this.props.trainee.activeQuestionIndex
    ].isMarked;
  ...
  onAnswerChange = (d1, d2, d3) => {
    var ansCount = this.props.trainee.questions[
      this.props.trainee.activeQuestionIndex
    ].anscount;
    if (d2) {
    ...
    return (
      <div>
          ...
          <Row>
            ...
            <Col span={22}>
              <Radio.Group style={{ float: "right" }}>
                <Radio.Button style={{ background: "#009999", color: "#fff" }}>
        ...
        <div className="control-button-in-exam-portal">
          <Button.Group>
            {this.props.trainee.activeQuestionIndex === 0 ? null : (
              <Button
                style={{ background: "#009999", color: "#fff" }}
